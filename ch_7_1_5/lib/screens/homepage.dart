...
class _homepageState extends State<homepage> {
  ...
  List MyI = [
    ...
    const Icon(Icons.gamepad,size: 50,),
    const Icon(Icons.close,size: 50,),
    const Icon(Icons.save,size: 50,),
    const Icon(Icons.call,size: 50,),
    const Icon(Icons.add,size: 50,),
    const Icon(Icons.search,size: 50,),
    const Icon(Icons.menu,size: 50,),
    const Icon(Icons.keyboard_return_outlined,size: 50,),
    const Icon(Icons.security_update_good_rounded,size: 50,),
    const Icon(Icons.nordic_walking,size: 50,),
    const Icon(Icons.school_outlined,size: 50,),
    const Icon(Icons.local_hospital,size: 50,),
    const Icon(Icons.local_police,size: 50,),
    const Icon(Icons.warning,size: 50,),
    const Icon(Icons.broadcast_on_personal_rounded,size: 50,),
    const Icon(Icons.not_interested,size: 50,),
  ];
          ...
          children: [
            Expanded(
              ...
              child: Container(
                ...
                child: Icon(MyIcon,color: MyColor,size: 200,),
                ),
